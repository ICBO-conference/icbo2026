...
<div class="organizer-name">Asiyah Lin</div>
<div class="organizer-affil">OntoData Research and Solutions, LLC<br>Maryland, USA</div>
</div>

<div class="organizer-card">
<div class="organizer-name">Boonserm (Serm) Kulvatunyou</div>
<div class="organizer-affil">National Institute of Standards and Technology (NIST)<br>Maryland, USA</div>
</div>

<div class="organizer-card">
<div class="organizer-name">Sunghwan Kim</div>
<div class="organizer-affil">National Institutes of Health<br>Maryland, USA</div>
</div>

<div class="organizer-card">
<div class="organizer-name">Qian Zhu</div>
<div class="organizer-affil">National Institutes of Health<br>Maryland, USA</div>
</div>
...
<div class="organizer-card">
<div class="organizer-name">Anthony Huffman</div>
<div class="organizer-affil">Department of Computational Medicine and Bioinformatics, University of Michigan Medicine<br>Michigan, USA</div>
</div>

<div class="organizer-card">
<div class="organizer-name">Anna Maria Masci</div>
<div class="organizer-affil">Department of Data Impact and Governance, University of Texas, MD Anderson Cancer Center<br>Texas, USA</div>
</div>

<div class="organizer-card">
<div class="organizer-name">Qingliang Li</div>
<div class="organizer-affil">National Institutes of Health<br>Maryland, USA</div>
</div>
